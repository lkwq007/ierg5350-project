...
parser.add_argument('--cnn-activation-function',
                    type=str,
                    default='relu',
                    choices=dir(F),
                    help='Model activation function for a convolution layer')
parser.add_argument('--dense-activation-function',
                    type=str,
                    default='elu',
                    choices=dir(F),
...
parser.add_argument('--hidden-size',
                    ...
                    metavar='H',
                    help='Hidden size')
parser.add_argument('--belief-size',
                    type=int,
                    default=200,
                    metavar='H',
...
parser.add_argument('--seed-episodes',
                    ...
                    metavar='S',
                    help='Seed episodes')
parser.add_argument('--collect-interval',
                    type=int,
                    default=100,
                    metavar='C',
...
parser.add_argument('--model_learning-rate',
                    type=float,
                    default=1e-3,
                    metavar='α',
                    help='Learning rate')
parser.add_argument('--actor_learning-rate',
                    type=float,
                    default=8e-5,
                    metavar='α',
                    help='Learning rate')
parser.add_argument('--value_learning-rate',
                    type=float,
                    default=8e-5,
                    metavar='α',
                    help='Learning rate')
parser.add_argument(
    ...
    metavar='αS',
    help=
    'Linear learning rate schedule (optimisation steps from 0 to final learning rate; 0 to disable)'
)
...
parser.add_argument('--planning-horizon',
                    type=int,
                    default=15,
                    metavar='H',
...
parser.add_argument('--discount',
                    ...
                    metavar='H',
                    help='Planning horizon distance')
parser.add_argument('--disclam',
                    type=float,
                    default=0.95,
                    metavar='H',
                    help='discount rate to compute return')
parser.add_argument('--optimisation-iters',
                    type=int,
                    default=10,
                    metavar='I',
...
parser.add_argument('--experience-replay',
                    type=str,
                    default='',
                    metavar='ER',
...
for episode in tqdm(range(metrics['episodes'][-1] + 1, args.episodes + 1),
    ...
    for s in tqdm(range(args.collect_interval)):
        ...
        value_dist = Normal(
            bottle(value_model, (value_beliefs, value_prior_states)),
